  ...
  it(
    ...
    async () => {
      ...
      const deploymentData = await getContractInstanceFromInstantiationParams(TokenContractArtifact, {
        ...
        constructorArgs: ['PrivateToken', 'PT', 18, deployerWallet, AztecAddress.ZERO, deployerWallet],
        salt,
      ...
      const { contract } = await deployer
        .deploy('PrivateToken', 'PT', 18, deployerWallet, AztecAddress.ZERO, deployerWallet)
        .send({
  ...
  it(
    ...
    async () => {
      ...
      const deploymentData = await getContractInstanceFromInstantiationParams(TokenContractArtifact, {
        ...
        constructorArgs: ['PrivateToken', 'PT', 18, 1, deployerWallet, AztecAddress.ZERO, deployerWallet],
        salt,
        deployer: deployerWallet,
      });
      ...
      const { contract } = await deployer
        .deploy('PrivateToken', 'PT', 18, 1, deployerWallet, AztecAddress.ZERO, deployerWallet)
