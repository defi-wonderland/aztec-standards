...
describe('Tokenized Vault', () => {
  ...
  describe('Issue failures: incorrect amounts', () => {
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          vault.methods
            .issue_public_to_public(alice, alice, sharesRequested, maxAssets, 0)
            .send({ from: alice })
            .wait(),
        ).rejects.toThrow(/app_logic_reverted/);
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          vault.methods
            .issue_public_to_private(alice, alice, sharesRequested, maxAssets, 0)
            .send({ from: alice })
            .wait(),
        ).rejects.toThrow(/app_logic_reverted/);
  ...
  describe('Constructor with asset and initial deposit', () => {
    ...
    it(
      'deploys vault with initial deposit successfully',
      async () => {
        ...
        const vaultWithDeposit = await deployVaultWithInitialDeposit(
          wallet,
          alice,
          assetContract,
          initialDeposit,
    ...
    it(
      'deploys vault with initial deposit successfully with different depositor',
      async () => {
    ...
    it(
      'subsequent depositor receives proportional shares',
      async () => {
    ...
    it(
      'vault with initial deposit handles yield correctly',
      async () => {
        // Deploy vault with initial deposit
        const vaultWithDeposit = await deployVaultWithInitialDeposit(
          wallet,
    ...
    it(
      'fails deployment without authwit',
      async () => {
    ...
    it(
      'fails deployment with insufficient balance',
      async () => {
